...
// ─────────────────────────────────────────────────────────
const V3_CHAOS = [
  { text: 'draft v3 (worse)',    x: 100, y: 880,  rot: -5, w: 420, delay: 0.0,  bg: '#FFF8E0' },
  { text: 'same intro again',    x: 540, y: 940,  rot: 4,  w: 460, delay: 0.06, bg: '#FFFFFF', highlight: true },
  { text: 'tone keeps drifting', x: 140, y: 1080, rot: -2, w: 460, delay: 0.12, bg: '#FFFFFF' },
  { text: 'rewrite the sign-off',x: 580, y: 1130, rot: 3,  w: 480, delay: 0.18, bg: '#FFF8E0' },
  { text: 're: re: re: …',       x: 90,  y: 1280, rot: 2,  w: 360, delay: 0.24, bg: '#FFFFFF' },
  { text: 'which template now?', x: 520, y: 1320, rot: -3, w: 460, delay: 0.30, bg: '#FFF8E0' },
];
        ...
        {({ localTime }) => {
          ...
          return (
            <div style={{
              ...
              {[
                { delay: 0.5, text: '"Reply to Anna. Friendly but firm. Mention the timeline…"' },
                { delay: 0.95, text: '"Reply to Anna — friendly but firm, timeline note…"' },
                { delay: 1.4, text: '"Anna again. Friendly, firm, timeline. You know."' },
              ].map((bubble, i) => {
...
// ─────────────────────────────────────────────────────────
const V3_PIPELINE = [
  { label: 'Email Voice Skill',   sub: 'Claude opens already knowing your tone.',
    eyebrow: 'STEP 01', caption: 'Context loads.' },
  { label: 'PersonalizationOS',   sub: 'past replies · sign-off · do-not-say list',
    eyebrow: 'STEP 02', caption: 'Workflow starts.' },
  { label: 'Reply, your voice',   sub: 'first draft already sounds like you',
