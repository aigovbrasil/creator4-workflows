...
// ─────────────────────────────────────────────────────────
const V3_CHAOS = [
  { text: 'prompts antigos',     x: 100, y: 880,  rot: -5, w: 420, delay: 0.0,  bg: '#FFF8E0' },
  { text: 'mesmo contexto',      x: 540, y: 940,  rot: 4,  w: 460, delay: 0.06, bg: '#FFFFFF', highlight: true },
  { text: 'decisões perdidas',   x: 140, y: 1080, rot: -2, w: 460, delay: 0.12, bg: '#FFFFFF' },
  { text: 'outputs diferentes',  x: 580, y: 1130, rot: 3,  w: 480, delay: 0.18, bg: '#FFF8E0' },
  { text: 'reescrever',          x: 90,  y: 1280, rot: 2,  w: 360, delay: 0.24, bg: '#FFFFFF' },
  { text: 'qual chat era?',      x: 520, y: 1320, rot: -3, w: 440, delay: 0.30, bg: '#FFF8E0' },
];
        ...
        {({ localTime }) => {
          ...
          return (
            <div style={{
              ...
              {[
                { delay: 0.5, text: '"Oi, estou num projeto de voz de marca. Tom direto, seco…"' },
                { delay: 0.95, text: '"Lembrete: projeto de voz de marca. Tom direto…"' },
                { delay: 1.4, text: '"Voz de marca. Direto. Seco. Igual ontem."' },
              ].map((bubble, i) => {
...
// ─────────────────────────────────────────────────────────
const V3_STACK = [
  { label: 'Contexto',   sub: 'quem você é, toda vez' },
  { label: 'Workflows',  sub: 'rotinas repetíveis' },
  { label: 'Skills',     sub: 'ferramentas que já te conhecem' },
  { label: 'Templates',  sub: 'forma, não só palavras' },
  { label: 'Decisões',   sub: 'escolhas que persistem' },
];
...
// ─────────────────────────────────────────────────────────
const V3_PIPELINE = [
  { label: 'Creator Entry Skill', sub: 'Claude já abre te conhecendo.',
    eyebrow: 'PASSO 01', caption: 'Context loads.' },
  { label: 'PersonalizationOS',   sub: 'voz · decisões · rotinas',
    eyebrow: 'PASSO 02', caption: 'Workflow starts.' },
  { label: 'Output Consistente',  sub: 'na marca · na voz · no tempo',
    eyebrow: 'PASSO 03', caption: 'Output gets consistent.' },
];
...
const V3_TREE = [
  ...
  { name: 'suites/',      desc: 'workflows · rotinas',         delay: 0.18 },
  { name: 'docs/',        desc: 'como o sistema pensa',        delay: 0.36 },
  { name: 'validation/',  desc: 'testes de consistência',      delay: 0.54 },
  { name: 'README.md',    desc: 'comece aqui',                 delay: 0.72, file: true },
];
...
function SceneV3_GitHub({ start, end }) {
  return (
    <Sprite start={start} end={end}>
      ...
      <Sprite start={start + 0.05} end={end - 0.05}>
        <EyebrowPill text="PROVA PÚBLICA" color={V3_OK} dotColor={V3_OK} />
      </Sprite>
            ...
            <div style={{
              ...
              <div style={{ padding: '28px 32px 22px', borderBottom: `1px solid ${V3_RULE}` }}>
                ...
                <div style={{
                  ...
                  <span style={{ alignSelf: 'center', color: V3_MUTED }}>·</span>
                  <span style={{ alignSelf: 'center', color: V3_MUTED }}>Starter Público</span>
                </div>
              </div>
    ...
    <Sprite start={start} end={end}>
      <div style={{ position: 'absolute', inset: 0, background: V3_INK, overflow: 'hidden' }}>
        ...
        <Sprite start={start + 0.1} end={end - 0.05}>
          {({ localTime }) => {
            const lines = [
              { text: 'Teste o', delay: 0.0, accent: false },
              { text: 'starter', delay: 0.12, accent: true },
              { text: 'público.', delay: 0.24, accent: true },
            ];
            return (
          ...
          {({ localTime }) => {
            ...
            return (
              <div style={{
                ...
                Workflows, skills e templates<br/>
                para criadores não-devs.
              </div>
            );
          }}
        </Sprite>
