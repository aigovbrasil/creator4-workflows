...
// ─────────────────────────────────────────────────────────
const V3_CHAOS = [
  { text: 'reschedule again',     x: 100, y: 880,  rot: -5, w: 440, delay: 0.0,  bg: '#FFF8E0' },
  { text: 'find a 30m slot',      x: 540, y: 940,  rot: 4,  w: 460, delay: 0.06, bg: '#FFFFFF', highlight: true },
  { text: '3 time zones',         x: 140, y: 1080, rot: -2, w: 380, delay: 0.12, bg: '#FFFFFF' },
  { text: 'block deep work',      x: 580, y: 1130, rot: 3,  w: 440, delay: 0.18, bg: '#FFF8E0' },
  { text: 'mute Slack',           x: 90,  y: 1280, rot: 2,  w: 360, delay: 0.24, bg: '#FFFFFF' },
  { text: 'which day was free?',  x: 520, y: 1320, rot: -3, w: 460, delay: 0.30, bg: '#FFF8E0' },
];
        ...
        {({ localTime }) => {
          ...
          return (
            <div style={{
              ...
              {[
                { delay: 0.5, text: '"Find me 2 hours tomorrow for deep work. No meetings."' },
                { delay: 0.95, text: '"2h tomorrow. Deep work. Block calendar. Mute Slack."' },
                { delay: 1.4, text: '"Same routine I asked you to remember last week."' },
              ].map((bubble, i) => {
...
// ─────────────────────────────────────────────────────────
const V3_PIPELINE = [
  { label: 'Routine Skill',       sub: 'Claude already knows your week.',
    eyebrow: 'STEP 01', caption: 'Context loads.' },
  { label: 'PersonalizationOS',   sub: 'deep-work hours · meeting rules · do-not-disturb',
    eyebrow: 'STEP 02', caption: 'Workflow starts.' },
  { label: 'Week, blocked',       sub: 'time guarded before chaos starts',
