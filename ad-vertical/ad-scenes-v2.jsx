...
// ─────────────────────────────────────────────────────────
const CHAOS_BLOCKS = [
  { text: 'old prompts',         x: 80,  y: 700,  rot: -4, w: 380, h: 130, delay: 0.0, color: '#FFF8E0' },
  { text: 'lost decisions',      x: 540, y: 760,  rot: 3,  w: 440, h: 130, delay: 0.12, color: '#FFFFFF' },
  { text: 'project context',     x: 140, y: 880,  rot: -2, w: 460, h: 130, delay: 0.22, color: '#FFFFFF' },
  { text: 'same briefing again', x: 620, y: 920,  rot: 4,  w: 460, h: 130, delay: 0.32, color: '#FFF8E0' },
  { text: 'voice of march?',     x: 90,  y: 1060, rot: 2,  w: 420, h: 120, delay: 0.42, color: '#FFFFFF' },
  { text: 'which chat was it?',  x: 540, y: 1080, rot: -3, w: 460, h: 120, delay: 0.52, color: '#FFF8E0' },
  { text: 'copy from doc/12',    x: 140, y: 1230, rot: 1,  w: 420, h: 120, delay: 0.62, color: '#FFFFFF' },
  { text: 'rewrite (again)',     x: 580, y: 1260, rot: -2, w: 420, h: 120, delay: 0.72, color: '#FFF8E0' },
];
...
// ─────────────────────────────────────────────────────────
const SYSTEM_STACK = [
  { label: 'Context',    sub: 'who you are, every time',         color: V2_INK },
  { label: 'Workflows',  sub: 'repeatable routines',             color: V2_INK },
  { label: 'Skills',     sub: 'tools that already know you',     color: V2_INK },
  { label: 'Templates',  sub: 'shape, not just words',           color: V2_INK },
  { label: 'Decisions',  sub: 'choices that persist',            color: V2_INK },
];
...
const PIPELINE = [
  {
    ...
    sub:   'Claude opens already knowing you.',
    eyebrow: 'STEP 01',
    caption: 'Context loads.',
    captionAccent: V2_ACCENT,
    rangeStart: 0.1, rangeEnd: 1.4,
  },
  {
    label: 'PersonalizationOS',
    sub:   'voice · decisions · routines',
    eyebrow: 'STEP 02',
    caption: 'Workflow starts.',
    captionAccent: V2_ACCENT,
    rangeStart: 1.3, rangeEnd: 2.6,
  },
  {
    label: 'Consistent Output',
    sub:   'on-brand · on-voice · on-time',
    eyebrow: 'STEP 03',
    caption: 'Output gets consistent.',
    captionAccent: V2_OK,
...
const V2_TREE = [
  ...
  { name: 'suites/',      desc: 'workflows · routines',        delay: 0.2 },
  { name: 'docs/',        desc: 'how the system thinks',       delay: 0.4 },
  { name: 'validation/',  desc: 'tests for consistency',       delay: 0.6 },
  { name: 'README.md',    desc: 'start here',                  delay: 0.8, file: true },
];
          ...
          {({ localTime }) => {
            ...
            return (
              <div style={{
                ...
                <div style={{
                  fontFamily: V2_SANS, fontSize: 110, fontWeight: 700,
            ...
            return (
              <div style={{
                ...
                <div style={{
                  ...
                  <span>Try the public starter</span>
                  <div style={{
