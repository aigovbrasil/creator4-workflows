---
title: "Ajuste de fundo e cores do arquivo"
date: 2026-02-23
account: contatotdahadulto@gmail.com
uuid: ccbf2991-28c3-4e1d-934a-8802c536bd58
messages: 2
tags: []
context: ""
---
...
execute o prpomtp entregue um arquivo unico para baixar ajuste apenas fundo para para nao ficar branco total use cinza claro igual da sua identidade visual e as linhas devem ser em preto
...
1	---
    ...
    43	
File created successfully: /mnt/user-data/outputs/cubo_dashboard_completo.html
Um arquivo único com as 4 folhas A4 prontas para imprimir — fundo em cinza claro `#EBEBEB`, todas as linhas (corte, dobra, escrita) em preto.

**Estrutura entregue:**
- **Página 1** — Cubo 1 Folha A: TOPO "Ritual de Domingo" + FRENTE "Foco Urgente" + ESQUERDA "Estudo"
- **Página 2** — Cubo 1 Folha B: DIREITA "Financeiro + Leitura" + VERSO "Vida Prática" + BASE "Metadados"
- **Página 3** — Cubo 2 Folha A: TOPO "Dashboard Master" + FRENTE "Prioritário + Estudo" + ESQUERDA "Financeiro + Rotina"
- **Página 4** — Cubo 2 Folha B: DIREITA "Metas Intelectuais + Wishlist" + VERSO "Projetos" + BASE "Índice das faces"

Abas de cola em laranja tracejado, linhas de dobra em tracejado escuro, legenda de montagem no rodapé de cada folha. As instruções de impressão aparecem na tela mas não saem impressas.