---
title: "Linear app e integração com Claude"
date: 2026-04-03
account: leonardopimentel.knh@gmail.com
uuid: e5c80a55-043f-4dda-bde9-75b128638259
messages: 6
tags: []
context: ""
---
...
Para que serve o app linear e a integrcaao com claud ?

---

**Claude** _2026-04-03_

{"results":[{"name":"Linear","description":"Manage issues, projects & team workflows in Linear","tools":["list_comments","create_comment","list_cycles","get_document","list_documents","get_issue","list_issues","create_issue","+14 more"],"url":"https://mcp.linear.app/mcp","iconUrl":"https://mcp.linear.app/mcp","directoryUuid":"fa50c30c-9f62-4f94-b851-217868185db6","connected":false,"enabledInChat":false},{"name":"Zoho Projects","description":"Zoho Projects MCP for Task & Project Automation","tools":["getAllPortals","getPortalDetails","getAllProjects","getProjectDetails","createProject","updateProject","trashProject","restoreProject","+22 more"],"iconUrl":"https://www.zoho.com/mcp/","directoryUuid":"bec78036-b8e2-4af1-9ccc-daec0669f426","connected":false,"enabledInChat":false},{"name":"Atlassian Rovo","description":"Access Jira & Confluence from Claude","tools":["atlassianUserInfo","getAccessibleAtlassianResources","getConfluenceSpaces","getConfluencePage","getPagesInConfluenceSpace","getConfluencePageAncestors","getConfluencePageFooterComments","getConfluencePageInlineComments","+23 more"],"url":"https://mcp.atlassian.com/v1/mcp","iconUrl":"https://www.atlassian.com","directoryUuid":"11ba10d9-477b-4988-bd1c-90a7fa680dc1","connected":false,"enabledInChat":false},{"name":"Pylon","description":"Search and manage Pylon support issues","tools":["create_issue","get_account","get_contact","get_issue","get_issue_messages","get_user","search_accounts","search_issues","+2 more"],"url":"https://mcp.usepylon.com/","iconUrl":"https://www.usepylon.com","directoryUuid":"240b8712-17ed-4233-858a-9a872dec63b2","connected":false,"enabledInChat":false},{"name":"Mixpanel","description":"Analyze, query, and manage your Mixpanel data","tools":["Get-Projects","Get-Events","Get-Event-Details","Get-Property-Names","Get-Property-Values","Edit-Event","Edit-Property","Create-Tag","+12 more"],"url":"https://mcp.mixpanel.com/mcp","iconUrl":"https://mixpanel.com/","directoryUuid":"29d60a67-6f16-489b-8a1e-efdcece8d1f6","connected":false,"enabledInChat":false},{"name":"DevRev","description":"Search and update your company's knowledge graph","tools":["create_issue","update_issue","get_issue","list_issues","create_ticket","update_ticket","get_ticket","get_enhancement","+6 more"],"url":"https://api.devrev.ai/mcp/v1","iconUrl":"https://devrev.ai/","directoryUuid":"7b562d2-7e99-42ad-bd85-b2c0a67fb323","connected":false,"enabledInChat":false},{"name":"Sentry","description":"Search, query, and debug errors intelligently","tools":["whoami","find_organizations","find_teams","find_projects","find_issues","find_releases","find_tags","get_issue_details","+12 more"],"url":"https://mcp.sentry.dev/mcp","iconUrl":"https://sentry.io/","directoryUuid":"46d6322a-5f75-4822-b739-f49261805e9c","connected":false,"enabledInChat":false},{"name":"Ticket Tailor","description":"Event platform for managing tickets, orders & more","tools":["bundle_create","bundle_delete","bundle_update","check_in_create","check_ins_get","checkout_form_element_by_id_get","checkout_form_element_update","checkout_form_elements_get","+57 more"],"url":"https://mcp.tickettailor.ai/mcp","iconUrl":"https://www.tickettailor.com/","directoryUuid":"7a28094f-541d-4ef8-89e2-6abc653d77a2","connected":false,"enabledInChat":false},{"name":"Ahrefs","description":"SEO & AI search analytics","tools":["batch-analysis","brand-radar-ai-responses","brand-radar-cited-domains","brand-radar-cited-pages","brand-radar-impressions-history","brand-radar-impressions-overview","brand-radar-mentions-history","brand-radar-mentions-overview","+53 more"],"url":"https://api.ahrefs.com/mcp/mcp","iconUrl":"https://ahrefs.com/favicon.ico","directoryUuid":"098cb32a-ba21-4770-97dd-78bb54655419","connected":false,"enabledInChat":false},{"name":"Natoma","description":"Access all your internal tools, enterprise apps & data.","tools":["atlassianUserInfo","getJiraIssue","editJiraIssue","lookupJiraAccountId","addCommentToJiraIssue","list-collections","list-databases","collection-indexes","+12 more"],"iconUrl":"https://www.natoma.ai","directoryUuid":"1e18ff95-3f46-4285-98e5-0bb6021d06df","connected":false,"enabledInChat":false}]}
## O que é o Linear?

**Linear** é uma ferramenta de gerenciamento de projetos e issues focada em times de tecnologia (devs, produto, design). Ele é conhecido por ser extremamente rápido, limpo e bem integrado com fluxos de desenvolvimento de software.

Com o Linear você consegue:
- Criar e acompanhar **issues** (tarefas, bugs, melhorias)
- Organizar o trabalho em **projetos** e **ciclos** (sprints)
- Gerenciar **workflows** do time com status personalizados
- Conectar com GitHub, GitLab, Slack, Figma, entre outros

---

## Integração do Linear com o Claude

Conectando o Linear ao Claude via MCP (Model Context Protocol), você consegue interagir com seus projetos **diretamente no chat**, usando linguagem natural. Algumas coisas que você pode fazer:

- 📋 **Listar issues** — "quais são as tarefas abertas no projeto X?"
- ✅ **Criar issues** — "cria uma issue de bug: botão de login não responde no mobile"
- 💬 **Adicionar comentários** em issues existentes
- 🔄 **Atualizar status** de tarefas
- 📁 **Consultar documentos e ciclos** do time
- 🔍 **Buscar issues** por filtros, assignees, prioridade etc.

---

## Por que isso é útil?

Em vez de alternar entre janelas, você pode pedir ao Claude para **resumir o backlog**, **criar várias issues de uma vez** a partir de uma lista, ou até **ajudar a priorizar tarefas** com base no contexto do seu projeto — tudo sem sair do chat.

Quer conectar o Linear agora?
{"connectors":[{"name":"Linear","description":"Manage issues, projects & team workflows in Linear","url":"https://mcp.linear.app/mcp","iconUrl":"https://mcp.linear.app/mcp","directoryUuid":"fa50c30c-9f62-4f94-b851-217868185db6"}],"keywords":["issues"]}
Conectando sua conta do Linear, você já pode começar a gerenciar tudo por aqui! 🚀

---

**Você** _2026-04-03_

Como posso atraves de um prompt enviar um escopo de projeto em texto arquivo rascinhado e pedir ao claude que aplique melhores praticas decomponha addciono o projeto no linear ?

---

**Claude** _2026-04-03_

Ótimo caso de uso! O fluxo completo ficaria assim:

---

## Fluxo: Escopo → Boas Práticas → Linear

### 1. 📎 Envie o arquivo de escopo
Você pode simplesmente **anexar o arquivo** (`.txt`, `.docx`, `.pdf`, `.md`) aqui no chat, ou **colar o texto** diretamente na mensagem.

---

### 2. 🧠 Use um prompt estruturado como este:

```
Aqui está o escopo do meu projeto:

[cole o texto ou anexe o arquivo]

Por favor:
1. Analise o escopo e aplique boas práticas de gestão de projetos
2. Decomponha em Epics, e cada Epic em Issues menores e acionáveis
3. Para cada issue, defina:
   - Título claro
   - Descrição com contexto e critérios de aceite
   - Prioridade (urgent / high / medium / low)
   - Estimativa de esforço se possível
4. Crie o projeto no Linear com o nome [Nome do Projeto]
5. Adicione todas as issues criadas ao projeto
```

---

### 3. ⚙️ O que o Claude faz por baixo dos panos

```
Escopo (texto/arquivo)
        ↓
  Análise + Boas Práticas
        ↓
  Decomposição em Epics/Issues
        ↓
  Chamadas à API do Linear via MCP:
  - create_project
  - create_issue (para cada tarefa)
  - create_comment (com detalhes extras)
```

---

### 4. 💡 Dicas para um resultado melhor

| Dica | Por quê |
|---|---|
| Inclua o **objetivo de negócio** no escopo | O Claude prioriza melhor |
| Mencione a **stack tecnológica** | As issues ficam mais técnicas e precisas |
| Diga o **tamanho do time** | Ajuda a calibrar granularidade das tarefas |
| Peça para usar **labels** específicas | Ex: `frontend`, `backend`, `infra` |
| Defina um **ciclo/sprint inicial** | O Claude pode já alocar as issues |

---

### Pronto para testar?

**Conecte o Linear** (se ainda não conectou) e depois **anexe ou cole seu escopo** aqui — eu faço todo o processo pra você agora! 🚀
{"connectors":[{"name":"Linear","description":"Manage issues, projects & team workflows in Linear","url":"https://mcp.linear.app/mcp","iconUrl":"https://mcp.linear.app/mcp","directoryUuid":"fa50c30c-9f62-4f94-b851-217868185db6"}],"keywords":["issues"]}
...
seguindo as melhores praticas inclusive de workflow quais seriam os outros conetores que devo fromatar e por que ? e como funcionariam ? GitHub, GitLab, Slack, Figma, entre outros

---

**Claude** _2026-04-03_

{"results":[{"name":"Slack","description":"Send messages, create canvases, and fetch Slack data","tools":["slack_send_message","slack_search_public_and_private","slack_search_users","slack_search_channels","slack_search_public","slack_read_channel","slack_read_thread","slack_create_canvas","+3 more"],"url":"https://mcp.slack.com/mcp","iconUrl":"https://slack.com","directoryUuid":"597f662f-36de-437e-836e-5a81013cbfbe","connected":false,"enabledInChat":false},{"name":"Figma","description":"Generate diagrams and better code from Figma context","tools":["generate_diagram","get_design_context","get_screenshot","get_metadata","create_design_system_rules","get_variable_defs","get_code_connect_map","get_figjam","+1 more"],"url":"https://mcp.figma.com/mcp","iconUrl":"https://www.figma.com","directoryUuid":"c758d038-d8eb-4421-b426-9dd68dc7f84a","connected":false,"enabledInChat":false},{"name":"Notion","description":"Connect your Notion workspace to search, update, and power workflows across tools","tools":["search","fetch","create-pages","update-page","move-pages","duplicate-page","create-database","update-database","+5 more"],"url":"https://mcp.notion.com/mcp","iconUrl":"https://www.notion.so/images/notion-logo-block-main.svg","directoryUuid":"69f3a300-cc60-48c4-b237-dfac56530dbf","connected":false,"enabledInChat":false},{"name":"Atlassian Rovo","description":"Access Jira & Confluence from Claude","tools":["atlassianUserInfo","getAccessibleAtlassianResources","getConfluenceSpaces","getConfluencePage","getPagesInConfluenceSpace","getConfluencePageAncestors","getConfluencePageFooterComments","getConfluencePageInlineComments","+23 more"],"url":"https://mcp.atlassian.com/v1/mcp","iconUrl":"https://www.atlassian.com","directoryUuid":"11ba10d9-477b-4988-bd1c-90a7fa680dc1","connected":false,"enabledInChat":false},{"name":"Natoma","description":"Access all your internal tools, enterprise apps & data.","tools":["atlassianUserInfo","getJiraIssue","editJiraIssue","lookupJiraAccountId","addCommentToJiraIssue","list-collections","list-databases","collection-indexes","+12 more"],"iconUrl":"https://www.natoma.ai","directoryUuid":"1e18ff95-3f46-4285-98e5-0bb6021d06df","connected":false,"enabledInChat":false},{"name":"Supabase","description":"Manage databases, authentication, and storage","tools":["list_organizations","get_organization","list_projects","get_project","get_cost","confirm_cost","create_project","pause_project","+24 more"],"url":"https://mcp.supabase.com/mcp","iconUrl":"https://supabase.com","directoryUuid":"11ca66fc-1e98-49d5-ab9b-7cb4672a8f10","connected":false,"enabledInChat":false},{"name":"PostHog","description":"Query, analyze, and manage your PostHog insights","tools":["query-run","query-generate-hogql-from-question","insight-create-from-query","insight-get","insights-get-all","insight-update","insight-delete","insight-query","+49 more"],"url":"https://mcp.posthog.com/mcp","iconUrl":"https://posthog.com","directoryUuid":"50688846-553c-4a12-bc21-df94d2173734","connected":false,"enabledInChat":false},{"name":"Ahrefs","description":"SEO & AI search analytics","tools":["batch-analysis","brand-radar-ai-responses","brand-radar-cited-domains","brand-radar-cited-pages","brand-radar-impressions-history","brand-radar-impressions-overview","brand-radar-mentions-history","brand-radar-mentions-overview","+53 more"],"url":"https://api.ahrefs.com/mcp/mcp","iconUrl":"https://ahrefs.com/favicon.ico","directoryUuid":"098cb32a-ba21-4770-97dd-78bb54655419","connected":false,"enabledInChat":false},{"name":"CMS Coverage","description":"Access the CMS Coverage Database","tools":["get_contractors","get_ncd","sad_exclusion_list","search_articles","search_lcds","search_nca_cals","search_ncds","whats_new_national"],"url":"https://hcls.mcp.claude.com/cms_coverage/mcp","iconUrl":"https://www.cms.gov/medicare/coverage/determination-process/basics","directoryUuid":"57dd8e8a-f030-4bb7-a9ed-4098933bd70b","connected":false,"enabledInChat":false},{"name":"Day AI","description":"Know everything about your prospects & customers with CRMx","tools":["open_sidebar","get_share_url","analyze_before_create_or_update","create_or_update_person_organization","create_or_update_opportunity","create_or_update_pipeline_stage","update_property_definition","read_crm_schema","+17 more"],"url":"https://day.ai/api/mcp","iconUrl":"https://day.ai","directoryUuid":"87d31b20-90c3-42ca-94a7-51270953869d","connected":false,"enabledInChat":false}]}
{"results":[{"name":"ICD-10 Codes","description":"Access ICD-10-CM and ICD-10-PCS code sets","tools":["get_hierarchy","get_by_category","get_by_body_system","lookup_code","search_diagnosis_by_code","search_diagnosis_by_description","search_procedure_by_code","search_procedure_by_description","+1 more"],"url":"https://hcls.mcp.claude.com/icd10_codes/mcp","iconUrl":"https://www.icd10data.com/ICD10CM/Codes","directoryUuid":"bd8c051d-df35-44c0-a8b8-084b700e1f21","connected":false,"enabledInChat":false},{"name":"Exa","description":"Web Search + Code Docs Search","tools":["web_search_exa","get_code_context_exa"],"url":"https://mcp.exa.ai/mcp","iconUrl":"https://exa.ai/","directoryUuid":"91408932-1110-4350-97c7-2d6b3a6d9694","connected":false,"enabledInChat":false},{"name":"Bitly","description":"Shorten links, generate QR Codes, and track performance","tools":["create_short_link","get_short_link_details","update_short_link","delete_short_link","expand","custom_backhalf","link_metrics","link_clicks_summary","+19 more"],"url":"https://api-ssl.bitly.com/v4/mcp","iconUrl":"https://bitly.com","directoryUuid":"b8f1c2a3-9d4e-5f6g-7h8i-9j0k1l2m3n4o","connected":false,"enabledInChat":false},{"name":"Razorpay","description":"Turn Claude into your Razorpay Dashboard Assistant","tools":["fetch_payment","fetch_all_payments","fetch_payment_card_details","fetch_order","fetch_all_orders","fetch_order_payments","fetch_payment_link","fetch_all_payment_links","+17 more"],"url":"https://mcp.razorpay.com/mcp","iconUrl":"https://razorpay.com","directoryUuid":"c4259182-2a73-4a5f-91ab-0867a3eade9d","connected":false,"enabledInChat":false},{"name":"Ticket Tailor","description":"Event platform for managing tickets, orders & more","tools":["bundle_create","bundle_delete","bundle_update","check_in_create","check_ins_get","checkout_form_element_by_id_get","checkout_form_element_update","checkout_form_elements_get","+57 more"],"url":"https://mcp.tickettailor.ai/mcp","iconUrl":"https://www.tickettailor.com/","directoryUuid":"7a28094f-541d-4ef8-89e2-6abc653d77a2","connected":false,"enabledInChat":false},{"name":"Microsoft Learn","description":"Search trusted Microsoft docs to power your development","tools":["microsoft_docs_search","microsoft_docs_fetch","microsoft_code_sample_search"],"url":"https://learn.microsoft.com/api/mcp","iconUrl":"https://learn.microsoft.com/en-us/","directoryUuid":"89a7ddf5-2a6b-410c-be11-aa0e1a1b35a6","connected":false,"enabledInChat":false},{"name":"Figma","description":"Generate diagrams and better code from Figma context","tools":["generate_diagram","get_design_context","get_screenshot","get_metadata","create_design_system_rules","get_variable_defs","get_code_connect_map","get_figjam","+1 more"],"url":"https://mcp.figma.com/mcp","iconUrl":"https://www.figma.com","directoryUuid":"c758d038-d8eb-4421-b426-9dd68dc7f84a","connected":false,"enabledInChat":false},{"name":"Glean","description":"Bring enterprise context to Claude and your AI tools","tools":["search","code_search","employee_search","chat","gmail_search","outlook_search","meeting_lookup","read_document"],"iconUrl":"https://glean.com","directoryUuid":"784c4da3-8956-462f-96c1-440c6a190dcc","connected":false,"enabledInChat":false},{"name":"Cloudflare Developer Platform","description":"Build applications with compute, storage, and AI","tools":["accounts_list","set_active_account","kv_namespaces_list","kv_namespace_create","kv_namespace_delete","kv_namespace_get","kv_namespace_update","workers_list","+16 more"],"url":"https://bindings.mcp.cloudflare.com/mcp","iconUrl":"https://bindings.mcp.cloudflare.com/mcp","directoryUuid":"2d60210c-dd92-4be0-b09c-3662f10445c9","connected":false,"enabledInChat":false},{"name":"PayPal","description":"Access PayPal payments platform","tools":["create_product","list_product","show_product_details","list_disputes","get_dispute","accept_dispute_claim","create_invoice","list_invoices","+20 more"],"url":"https://mcp.paypal.com/mcp","iconUrl":"https://mcp.paypal.com/mcp","directoryUuid":"001103b7-bcde-4b9c-b5d4-f209c2fed1f3","connected":false,"enabledInChat":false}]}
...
Aqui está um mapa visual completo do ecossistema de conectores, seguido pela explicação de cada um:
...
> Clique em qualquer ferramenta no diagrama para saber mais sobre ela. A linha tracejada representa o **ponto de entrada** do fluxo.

---

## Os conectores essenciais e por que usá-los

### 🔵 Linear — Gestão de Issues
**O hub central do projeto.** É onde vivem as tarefas. Com Claude conectado, você cria issues a partir do escopo, atualiza status, prioriza backlogs e gera relatórios — tudo por prompt.

---

### ⚫ GitHub / GitLab — Código-fonte
**O elo entre tarefa e código.** Embora não estejam ainda no MCP registry do Claude.ai, funcionam via integração nativa com o Linear (criar branch automaticamente ao abrir uma issue, fechar issue ao fazer merge). Com Claude Code, você vai além: o Claude lê o código, sugere implementações e abre PRs.

---

### 🟡 Slack — Comunicação e Alertas
**O canal de notificações.** Com o conector do Slack, o Claude pode mandar mensagens em canais específicos quando algo acontece: "Issue criada", "Sprint iniciado", "Bug crítico aberto". Você também pode acionar o Claude direto de uma conversa no Slack.

Exemplo de prompt:
```
Toda vez que criar um conjunto de issues no Linear, 
envie um resumo no canal #produto do Slack.
```

---

### 🩷 Figma — Design
**A ponte entre design e desenvolvimento.** Com o conector do Figma, o Claude consegue ler o contexto dos componentes de um arquivo, extrair tokens de design, gerar código React/HTML fiel ao layout e criar issues no Linear para cada componente que precisa ser implementado.

Exemplo de prompt:
```
Leia o arquivo Figma deste link, identifique os 
componentes da tela de onboarding e crie issues no Linear 
para cada um, com critérios de aceite baseados no design.
```

---

### 🩵 Notion — Documentação
**O repositório de conhecimento.** PRDs, specs técnicas, decisões de arquitetura — tudo vive no Notion. Com o Claude conectado, você pode pedir para ele ler um PRD do Notion e gerar automaticamente as issues no Linear, ou fazer o caminho inverso: criar a documentação a partir das issues.

---

### 🟠 Jira + Confluence (Atlassian Rovo)
**Alternativa enterprise ao Linear+Notion.** Se o time já usa o ecossistema Atlassian, o conector Rovo dá ao Claude acesso a issues do Jira e páginas do Confluence simultaneamente.

---

### 🟢 Supabase — Backend / Banco de dados
**Para times que desenvolvem o produto.** Com o Claude conectado ao Supabase, você pode pedir para criar tabelas, gerar migrations, verificar dados em produção ou criar issues no Linear a partir de erros no banco.

---

## O workflow completo em ação

```
Você envia o escopo (arquivo ou texto)
         ↓
Claude lê o Notion/Confluence (PRD existente, se houver)
         ↓
Claude lê o Figma (telas do produto, se existirem)
         ↓
Claude decompõe em Epics + Issues com critérios de aceite
         ↓
Claude cria tudo no Linear com prioridades e labels
         ↓
Claude notifica o time no Slack com o resumo do sprint
         ↓
Dev abre branch no GitHub vinculada à issue
         ↓
Ao fazer merge, issue fecha automaticamente no Linear
```

Quer conectar algum desses agora para montar o pipeline completo?
{"connectors":[{"name":"Linear","description":"Manage issues, projects & team workflows in Linear","url":"https://mcp.linear.app/mcp","iconUrl":"https://mcp.linear.app/mcp","directoryUuid":"fa50c30c-9f62-4f94-b851-217868185db6"},{"name":"Figma","description":"Generate diagrams and better code from Figma context","url":"https://mcp.figma.com/mcp","iconUrl":"https://www.figma.com","directoryUuid":"c758d038-d8eb-4421-b426-9dd68dc7f84a"},{"name":"Notion","description":"Connect your Notion workspace to search, update, and power workflows across tools","url":"https://mcp.notion.com/mcp","iconUrl":"https://www.notion.so/images/notion-logo-block-main.svg","directoryUuid":"69f3a300-cc60-48c4-b237-dfac56530dbf"},{"name":"Slack","description":"Send messages, create canvases, and fetch Slack data","url":"https://mcp.slack.com/mcp","iconUrl":"https://slack.com","directoryUuid":"597f662f-36de-437e-836e-5a81013cbfbe"}],"keywords":["issues","messages","design","docs"]}
Conecte os quatro acima e você terá o pipeline principal funcionando! 🚀